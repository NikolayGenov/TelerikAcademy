...
namespace InheritanceAndPolymorphism
{
    public class LocalCourse : Course
    {
        ...
        public LocalCourse(string name, string teacherName) : this(name, teacherName, null, null)
        {
        }

        public LocalCourse(string name, string teacherName, IList<string> students) : this(name, teacherName, students, null)
        {
        }
